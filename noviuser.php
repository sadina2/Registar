							...
							<div class="container">
								<br>
									<div class="edu_button">
										<a class="btn btn-primary btn-lg hvr-underline-from-left" href="index.html" role="button">Natrag </a>
...
if($result=mysqli_query($con,"select * from osoba where osobaIme='$id'")){

while($row = mysqli_fetch_array($result))
{

echo"<br/><b> Osoba:  </b>" . $row['osobaIme'] . " je registrovana u bazi.";


}
echo"</br>";
echo"Za više informacija obratite se administratoru.";
echo"<br><br><br><br>";
}
else
{	
echo '<script language="javascript">';
						echo 'alert("Osoba ne postoji!")';
